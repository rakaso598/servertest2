package com.example.servertest2.web;


import com.example.servertest2.common.MyUtil;
import com.example.servertest2.domain.dao.entity.Product;
import com.example.servertest2.domain.svc.ProductSVC;
import com.example.servertest2.web.api.ApiResponse;
import com.example.servertest2.web.req.product.ReqSave;
import com.example.servertest2.web.req.product.ReqUpdate;
...
public class ApiProductController {
  ...
  //등록
  @ResponseBody
  @PostMapping                        // post http://localhost:9090/api/products
  ...
  //조회
  @ResponseBody
  @GetMapping("/{pid}")               // get http://localhost:9090/api/products/123
  ...
  //수정
  @ResponseBody
  @PatchMapping("/{pid}")         // patch http://localhost:9090/api/products/123
  ...
  //삭제
  @ResponseBody
  @DeleteMapping("/{pid}")        // delete http://localhost:9090/api/products/123
  ...
  //목록
  @ResponseBody
  @GetMapping("/all")                // get http://localhost:9090/api/products/all
